...
# get core functions
$core_url = 'https://cdn.jsdelivr.net/gh/ScoopInstaller/Scoop/lib/core.ps1'
...
# download scoop zip
$zipurl = 'https://hub.fastgit.org/ScoopInstaller/Scoop/archive/master.zip'
...
$zipurl = 'https://hub.fastgit.org/lukesampson/scoop/archive/master.zip'
